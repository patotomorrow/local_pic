...
# 项目介绍
本项目立足留学领域，已构建起一个包含20类规模为510的知识实体，23类规模约1293个实体关系的知识图谱
包括以下两部分的内容：
1) 日本留学知识图谱构建
2) 基于日本留学知识图谱的精准检索
...
| study_abroad_process | 留学流程 | 专科毕业，能在日本读大学/硕士/专门吗 |
...
用户:大专，想去日本读专门
# neo4j显示图
![image](https://github.com/patotomorrow/local_pic/blob/main/%E5%A4%A7%E4%B8%93%E4%B8%93%E9%97%A8.jpg)
         
用户:大专，想去日本读硕士
# neo4j显示图
![image](https://github.com/patotomorrow/local_pic/blob/main/%E5%A4%A7%E4%B8%93%E7%A1%95%E5%A3%AB.jpg)

用户相似结构的问句中，涉及到学历、学位相关的关键词，只要包含在现有的词库中，都能够完成上述检索。

# 三、阶段总结（2021/1/13）
1、项目完成了留学知识图谱的基础构建，并基于此，可完成流程类问题的精准检索
2、项目还有不足：
1) 知识图谱内容还需再补充
2) 可检索问题类型还需再丰富
